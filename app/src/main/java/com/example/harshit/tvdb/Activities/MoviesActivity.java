...
import com.example.harshit.tvdb.Adapters.MovieAdapter;
...
public class MoviesActivity extends AppCompatActivity implements RecylerClickEvents {
            ...
            if (application != null) {
                ...
                call.enqueue(new Callback<Bean_GenreResponse>() {
                    ...
                    public void onFailure(Call<Bean_GenreResponse> call, Throwable t) {
                        ...
                        AppUtil.openNonInternetActivity(MoviesActivity.this, getResources().getString(R.string.something_went_wrong));
                        finish();
                    }
                });
    ...
    private void handleGenreData(ArrayList<Bean_Genre> genrelist) {
        if (genrelist != null) {
            ...
            genreAdapter = new GenreAdapter(genrelist, MoviesActivity.this, this);
...
// here i am adding few sample image links, you can add your own
    ...
    private void handleMoviesAccordingToGenre(ArrayList<Bean_MovieDetails> bean_movieList) {
        if (bean_movieList != null) {
            ...
            movieAdapter = new MovieAdapter(bean_movieList, MoviesActivity.this, this);
